...
export default function LoginPage() {
    return (
        <AuthLayout
            ...
            subtitle="Vui lòng đăng nhập để tiếp tục hành trình của bạn."
            leftSlogan="Hành trình thông minh, Khởi đầu tại đây."
        ...
        >
            ...
            <div className="relative flex items-center mb-6 lg:mb-8">
                ...
                <span className="flex-shrink mx-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Hoặc dùng Email</span>
                <div className="flex-grow border-t border-gray-100"></div>
            </div>
            ...
            <p className="text-center text-gray-500 text-sm">
                Chưa có tài khoản? <Link href="/auth/dang-ky" className="text-blue-600 font-bold hover:underline">Đăng ký ngay</Link>
            </p>
        </AuthLayout>
    );
}
